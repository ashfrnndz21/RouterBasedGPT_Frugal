...
export const POST = async (req: Request) => {
  try {
    ...
    // Use OrchestrationService for intelligent routing and caching
    const orchestrator = new OrchestrationService(searchHandler, embeddings);
    
    const emitter = await orchestrator.handleQuery(
      body.query,
      history,
      llm,
      embeddings,
