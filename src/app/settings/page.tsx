...
const PreferencesPanel = dynamic(() => import('@/components/Preferences/PreferencesPanel'), {
  ssr: false,
  loading: () => <div className="text-sm text-black/60 dark:text-white/60">Loading preferences...</div>
});

const DataManagement = dynamic(() => import('@/components/Preferences/DataManagement'), {
  ssr: false,
  loading: () => <div className="text-sm text-black/60 dark:text-white/60">Loading data management...</div>
});
