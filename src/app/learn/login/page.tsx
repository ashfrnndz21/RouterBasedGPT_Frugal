...
export default function LoginPage() {
  ...
  const handleGoogle = () => signIn('google', { callbackUrl: '/learn' })
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-5">
      <div className="w-full max-w-sm">
        ...
        <h1 className="font-display text-[22px] font-bold text-white text-center mb-1">Welcome back</h1>
        <p className="text-[12px] text-white/40 text-center mb-7">Sign in to continue your AI learning journey</p>
        ...
        <p className="text-center text-[12px] text-white/35">
          No account?{' '}
          <Link href="/learn/register" className="text-[#4F8EF7] hover:underline">Create one free</Link>
        </p>
      </div>
    </div>
  )
