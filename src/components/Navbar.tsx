import { Clock, Edit, Share, Trash, FileText, FileDown, History } from 'lucide-react';
...
// jspdf loaded dynamically on demand (~300KB)
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1 min-w-0">
              ...
              <button
                ...
                title="Chat History"
              >
                <History size={16} className="text-black/60 dark:text-white/60" />
              </button>
